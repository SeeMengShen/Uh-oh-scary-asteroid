...
GameOverMenu::GameOverMenu(int highScore)
{
	this->highScore = highScore;
}

void GameOverMenu::init(GameManager* gameManager)
{
	...
	//"Game Over" Text
	Text* gameOverText = new Text("Game Over!\0", 100, 100, 500, 200, 255, 255, 255, new D3DXVECTOR2(-125, -150), true);

	highScoreString = to_string(highScore);

	//Display Score Text
	Text* scoreText = new Text("Your Score: \0", 100, 100, 500, 200, 255, 255, 255, new D3DXVECTOR2(-125, -75), false);
	Text* scoreValue = new Text(highScoreString, 100, 100, 500, 200, 255, 255, 255, new D3DXVECTOR2(30, -75), false);
	...
	uiPanel->vecLbls.push_back(gameOverText);
	uiPanel->vecLbls.push_back(scoreText);
	uiPanel->vecLbls.push_back(scoreValue);
...
void GameOverMenu::update(GameManager* gameManager, int framesToUpdate, AudioManager* audioManager)
{
